  ...
  return (
    <header className="sticky top-0 z-50 border-b border-teal-500/20 bg-teal-800 text-white shadow-sm backdrop-blur-xl">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <Suspense
          fallback={<nav className="flex items-center gap-4 overflow-x-auto border-t border-white/10 py-3 text-sm font-medium text-white/90" />}
        >
          <NavLinks />
        </Suspense>
      </div>
    ...
    <nav className="flex items-center gap-4 overflow-x-auto border-t border-white/10 py-3 text-sm font-medium text-white/90">
      <div className="flex items-center gap-2 whitespace-nowrap">
        ...
        <a
          ...
          className={[
            "rounded-lg px-3 py-1.5 transition-all duration-200 ease-in-out",
            pathname.startsWith("/posts") && searchParams.get("category") === "Tool & Code"
              ? "border border-white/30 bg-white/20 text-white shadow-sm"
              : "text-white/80 hover:bg-white/10 hover:text-white",
          ].join(" ")}
        >
        ...
        <a
          ...
          className={[
            "rounded-lg px-3 py-1.5 transition-all duration-200 ease-in-out",
            pathname.startsWith("/posts") && searchParams.get("category") === "Bài viết chia sẻ"
              ? "border border-white/30 bg-white/20 text-white shadow-sm"
              : "text-white/80 hover:bg-white/10 hover:text-white",
          ].join(" ")}
        >
        ...
        <a
          ...
          className={[
            "rounded-lg px-3 py-1.5 transition-all duration-200 ease-in-out",
            pathname.startsWith("/posts") && searchParams.get("category") === "Khuyến mãi"
              ? "border border-white/30 bg-white/20 text-white shadow-sm"
              : "text-white/80 hover:bg-white/10 hover:text-white",
          ].join(" ")}
        >
